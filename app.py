...
<script>
  ...
  function InitThis() {
      ...
      document.getElementById('mensaje').innerHTML  = 'Dibuje un fish, car o tree';
...
def upload():
    try:
        ...
        return main_html.replace('</main>', f'<div style="text-align: center; padding: 20px; font-size: 30px; font-weight: bold; background-color: #f0f0f0; border: 1px solid #ccc; margin-top: 20px;"><p>Predicción: {resultado}</p></div></main>')
